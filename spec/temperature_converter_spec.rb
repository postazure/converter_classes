...
describe TemperatureConverter do
  ...
  describe '#to_celsius' do
    it "returns the original temperature when given celsius" do
      ...
      converted = TemperatureConverter.to_celsius(:celsius, 20)
      expect(converted).to be == 20
    end
    ...
    it "returns the temperature in celsius when given kelvin" do
      ...
      converted = TemperatureConverter.to_celsius(:kelvin, 250)
      expect(converted).to be_within(0.1).of(-23.15)
    end
    ...
    it "returns the temperature in celsius when given fahrenheit" do
      ...
      converted = TemperatureConverter.to_celsius(:fahrenheit, 100)
      expect(converted).to be_within(0.1).of(37.8)
    end
  end
  ...
  describe '#to_fahrenheit' do
    it "returns the original temperature when given fahrenheit" do
      ...
      converted = TemperatureConverter.to_fahrenheit(:fahrenheit, 100)
      expect(converted).to be == 100
    end
    ...
    it "returns the temperature in fahrenheit when given celsius" do
      ...
      converted = TemperatureConverter.to_fahrenheit(:celsius, 50)
      expect(converted).to be == 122
    end
    ...
    it "return the temperature in fahrenheit when given kelvin" do
      ...
      converted = TemperatureConverter.to_fahrenheit(:kelvin, 300)
      expect(converted).to be_within(0.1).of(80.33)
    end
  end
  ...
  describe '#to_kelvin' do
    it "returns the original temperature when given kelvin" do
      ...
      converted = TemperatureConverter.to_kelvin(:kelvin, 400)
      expect(converted).to be == 400
    end
    ...
    it "returns the temperature in kelvin when given celsius" do
      ...
      converted = TemperatureConverter.to_kelvin(:celsius, 10)
      expect(converted).to be == 283.15
    end
    ...
    it "returns the temperature in kelvin when given fahrenheit" do
      ...
      converted = TemperatureConverter.to_kelvin(:fahrenheit, 100)
      expect(converted).to be_within(0.1).of(310.95)
